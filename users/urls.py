...
from .views import CreateUserView, GetUserView, UpdateUserView, DeleteUserView,search_users,registered_users_count_view
...
urlpatterns = [
    ...
    path('registered-users-count/', registered_users_count_view, name='registered_users_count'),
